                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <a href="images/img_1.jpg" className="img-hover" data-fancybox="gallery">
                                ...
                                <img src="../assets/images/img_1.jpg" alt="Image placeholder" className="img-fluid" />
                            </a>
                        </div>
                        <div className="col-md-4">
                            <a href="images/img_2.jpg" className="img-hover" data-fancybox="gallery">
                                <span className="icon icon-search"></span>
                                <img src="../assets/images/img_2.jpg" alt="Image placeholder" className="img-fluid" />
                            </a>
                        </div>
                        <div className="col-md-4">
                            <a href="images/img_3.jpg" className="img-hover" data-fancybox="gallery">
                                <span className="icon icon-search"></span>
                                <img src="../assets/images/img_3.jpg" alt="Image placeholder" className="img-fluid" />
                            </a>
                        </div>
                        <div className="col-md-4">
                        ...
                        <div className="col-md-4">
                            <a href="../assets/images/img_2.jpg" className="img-hover" data-fancybox="gallery">
                                <span className="icon icon-search"></span>
                                <img src="../assets/images/img_2.jpg" alt="Image placeholder" className="img-fluid" />
                            </a>
                        </div>
